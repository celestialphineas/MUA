...
public class MUAeq extends BuiltInOperation {
    public MUAeq() {
        name = "eq";
        argc = 2;
    }
    ...
    throws MUAStackOverflowException, MUARuntimeException {
        ...
        } else if(obj1 instanceof NumObject && obj2 instanceof NumObject) {
            boolean result
                = ((NumObject)obj1).getVal() == ((NumObject)obj2).getVal();
            return new BooleanObject(result);
        } else if(obj1 instanceof WordObject && obj2 instanceof WordObject) {
            boolean result
                = ((WordObject)obj1).getVal().equals(((WordObject)obj2).getVal());
            return new BooleanObject(result);
        }
        ...
        MUAErrorMessage.error(ErrorStringResource.operation_eq,
